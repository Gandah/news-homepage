...
const Main = () => {
  ...
  return (
    <main className="flex flex-col gap-10 md:grid grid-cols-3 grid-rows-[minmax(0,_1fr)_250px] md:py-4 md:pl-4">
      <article className="grid gap-4 md:col-[1_/_span_2] md:row-start-1 md:row-end-2  md:grid-cols-2 md:grid-rows-[minmax(300px,_370px)_150px]">
        ...
        <div className="text-3xl font-bold p-4 pb-0 pl-0 md:col-[1_/_span_1] md:row-[2_/_span_1] md:font-extrabold md:text-5xl md:p-0">
          <h1 className='w-[70%]'>
        ...
        <div className='grid gap-4 md:grid-rows-[minmax(auto,_1fr)_1fr] md:pl-3 md:gap-8'>
          ...
          <div
            role="button"
            tabIndex={0}
            className={`bg-softRed hover:bg-darkBlue px-4 py-3 md:py-2 h-auto w-[50%] md:w-[40%] uppercase text-center md:grid place-items-center ${
      ...
      <Aside />
      <footer className="grid gap-8 md:row-[2_/_span_1] md:col-[1_/_span_3] md:grid-flow-col md:mt-10 md:py-5 z-10">
        <FooterCard
          numbering="01"
